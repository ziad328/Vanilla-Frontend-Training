    ...
    const invstorsbornin1500s = inventors.filter(inventors => inventors.year >= 1500 && inventors.year < 1600);
    console.table(invstorsbornin1500s);

    // Array.prototype.map()
    // 2. Give us an array of the inventors first and last names
     const invFirstLastNames = inventors.map(inventors => `${inventors.first} ${inventors.last}`);
    console.table(invFirstLastNames);
